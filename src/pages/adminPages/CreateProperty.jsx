  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        square_feet: formData.square_feet.toString(),
      ...
      case 1:
        return (
          <Motion.div
            ...
            className="space-y-6"
          >
            <div className="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 rounded-2xl p-4 sm:p-6 md:p-8 border border-blue-200 shadow-lg">
              ...
              >
                ...
                {!selectedLandlord && filteredLandlords.length > 0 && (
                  <Motion.div
                    ...
                    className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1 sm:gap-0 px-2"
                  >
                ...
                {filteredLandlords.length === 0 ? (
                  ...
                  >
                    ...
                    {searchTerm && (
                      <button
                        ...
                        className="mt-4 px-4 sm:px-6 py-1.5 sm:py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors text-xs sm:text-sm font-medium"
                      >
                        Clear Search
                      </button>
                    )}
                  ...
                  <div className="relative">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3 max-h-[400px] sm:max-h-[500px] overflow-y-auto pr-1 sm:pr-2 custom-scrollbar">
                          ...
                          return (
                            ...
                            >
                              <div
                                ...
                                className={`group relative p-2.5 sm:p-3 rounded-lg border cursor-pointer transition-all duration-200 ${
                                  isSelected
                              ...
                              >
                                ...
                                <div className="flex items-center gap-2 sm:gap-3 pr-5 sm:pr-6">
                                  {/* Avatar */}
                                  <div
                                    className={`w-9 h-9 sm:w-10 sm:h-10 rounded-lg flex items-center justify-center text-white font-semibold text-xs sm:text-sm transition-all duration-200 flex-shrink-0 ${
                                      isSelected
                ...
                <AnimatePresence>
                  {selectedLandlord && (
                    ...
                    >
                      <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-xl sm:rounded-2xl blur opacity-20"></div>
                      <div className="relative p-4 sm:p-5 md:p-6 bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 border-2 border-blue-300 rounded-xl sm:rounded-2xl shadow-xl">
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                          <div className="flex items-start sm:items-center gap-3 sm:gap-4 md:gap-5 min-w-0 flex-1">
                            <div className="relative flex-shrink-0">
                              <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-xl sm:rounded-2xl blur-md"></div>
                              <div className="relative w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-xl sm:rounded-2xl flex items-center justify-center text-white font-bold text-lg sm:text-xl md:text-2xl shadow-2xl">
                            ...
                            <div className="min-w-0 flex-1">
                              <div className="flex flex-col sm:flex-row sm:items-center gap-2 mb-1">
                                <h5 className="font-bold text-blue-900 text-base sm:text-lg md:text-xl truncate">
                                  {selectedLandlord.full_name}
                                </h5>
                                <div className="flex items-center gap-1.5 px-2 sm:px-2.5 py-1 bg-green-100 rounded-full self-start sm:self-auto">
                              ...
                              <p className="text-blue-700 font-semibold text-xs sm:text-sm truncate">
                              ...
                              {selectedLandlord.business_name && (
                                <div className="flex items-center gap-2 mt-1.5">
                                  <Building
                                    size={12}
                                    className="sm:w-3.5 sm:h-3.5 text-blue-600 flex-shrink-0"
                                  />
                          ...
                          <button
                            ...
                            className="group p-2 sm:p-3 text-blue-400 hover:text-red-600 hover:bg-red-50 rounded-xl transition-all duration-300 border-2 border-transparent hover:border-red-200 self-end sm:self-auto flex-shrink-0"
