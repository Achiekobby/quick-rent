...
import { ArrowLeft, Mail, Phone, Smartphone, ArrowRight, CheckCircle2 } from "lucide-react";
    ...
    return (
      <div className="relative">
        ...
        <input 
          ...
          name="phone"
          id="phone"
          className={`w-full pl-24 pr-4 py-4 rounded-xl border ${errors.phone ? 'border-red-500' : 'border-neutral-300'} focus:outline-none focus:ring-2 focus:ring-orange-500 shadow-sm`}
          placeholder="XX XXX XXXX"
          value={formData.phone.startsWith('233') ? formData.phone.substring(3) : formData.phone}
          onChange={(e) => {
            // Only allow numbers
              ...
              {success ? (
                ...
                >
                  ...
                  <p className="text-neutral-600 mb-6">
                    We've sent a verification code to {contactMethod === "email" ? formData.email : `+${formData.phone}`}
                  </p>
                  <p className="text-sm text-neutral-500">Redirecting you to verification page...</p>
                </Motion.div>
              ) : (
                <>
                  <Motion.h1 
                  ...
                  >
                    ...
                    >
                      <Mail className={`w-4 h-4 mr-2 transition-transform duration-300 ${contactMethod === "email" ? "scale-110" : ""}`} />
                      Email
                    </button>
                    <button
                      type="button"
                    ...
                    >
                      <Smartphone className={`w-4 h-4 mr-2 transition-transform duration-300 ${contactMethod === "phone" ? "scale-110" : ""}`} />
                      Phone
                    </button>
                  </Motion.div>
                    ...
                    <AnimatePresence mode="wait">
                      {contactMethod === "email" ? (
                        <Motion.div 
                          ...
                          className="space-y-2"
                        >
                          <label htmlFor="email" className="block text-sm font-medium text-neutral-700 text-left">
                            Email Address
                          </label>
                          <div className="relative">
                            ...
                            <input
                              ...
                              autoComplete="email"
                              required
                              className={`block w-full pl-10 pr-3 py-4 border ${errors.email ? 'border-red-500' : 'border-neutral-300'} rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent shadow-sm`}
                        ...
                        <Motion.div 
                          ...
                          className="space-y-2"
                        >
                          <label htmlFor="phone" className="block text-sm font-medium text-neutral-700 text-left">
                            Phone Number
                          </label>
                          <div className={errors.phone ? 'border border-red-500 rounded-xl' : ''}>
                            <PhoneInput />
                          </div>
                          {errors.phone && (
